...
export default function Journal() {
  ...
  return (
    <div className="min-h-screen p-8 relative">
      <div 
        className="absolute inset-0 z-0 before:absolute before:inset-0 before:bg-black/60"
        style={{
          backgroundImage: 'url("https://cdn.you.com/youagent-images/flux1_1-pro/bf31d831-c7bc-4c82-b505-7658906fa828.png")',
      ...
      <div className="relative z-10">
        ...
        {showNewEntryForm && (
          <Card className="mb-6 bg-black/80 border-gradient-peach-pink backdrop-blur-sm">
            <CardHeader>
        ...
        <div className="space-y-4">
          {entries.map((entry) => (
            <Card key={entry.id} className="bg-black/80 border-gradient-peach-pink backdrop-blur-sm">
              <CardHeader>
